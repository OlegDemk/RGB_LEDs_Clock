...
#define USER_OUTPUT_Pin GPIO_PIN_15
#define USER_OUTPUT_GPIO_Port GPIOC
#define BUTTON_4_Pin GPIO_PIN_0
#define BUTTON_4_GPIO_Port GPIOA
#define BUTTON_4_EXTI_IRQn EXTI0_IRQn
#define BUTTON_3_Pin GPIO_PIN_1
#define BUTTON_3_GPIO_Port GPIOA
#define BUTTON_3_EXTI_IRQn EXTI1_IRQn
#define USER_OUT_Pin GPIO_PIN_2
#define USER_OUT_GPIO_Port GPIOA
...
#define INT_RTC_EXTI_IRQn EXTI9_5_IRQn
